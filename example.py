...
print('Eulier phi of n:', collect(sequence.A000010, 10))
...
print('Triangular numbers:', collect(sequence.A000217, 10))
print('The squares:', collect(sequence.A000290, 10))
print('Square pyramidal numbers:', collect(sequence.A000330, 10))
print('Mersenne primes:', collect(sequence.A000668, 8))
print('Prime gaps:', collect(sequence.A001223, 10))
...
print('Smith numbers:', collect(sequence.A006753, 10))
print('Digital sum of n:', collect(sequence.A007953, 10))
print('Digital product of n:', collect(sequence.A007954, 10))
print('n is triqangular:', collect(sequence.A010054, 10))
print('Hoax numbers:', collect(sequence.A019506, 10))
print('Digit sum equals sum of prime factors:', collect(sequence.A063737, 10))
